...
const Card = ({ title, subtitle, body, linkText, link }) => {
    return (
        <div className="w-full h-full">
            <div className="card bg-amber-300 text-red-950 hover:bg-[#f5ca3c] hover:-translate-y-4 hover:shadow-2xl hover:shadow-[rgba(245,202,60,0.6)] w-full h-full flex flex-col">
                <div className="card-body text-justify flex-grow">
